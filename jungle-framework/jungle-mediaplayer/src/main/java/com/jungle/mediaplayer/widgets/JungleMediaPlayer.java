...
public class JungleMediaPlayer extends MediaPlayerFrame {
    ...
    private void initView() {
        ...
        findViewById(R.id.refresh_video).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LogUtils.e(TAG, "Will Replay Media From Position: %d.", position);
    ...
    private Runnable mAutoReloadWaitingRunnable = new Runnable() {
        @Override
        public void run() {
            LogUtils.e(TAG, "Auto-Reload Failed, Will Show Error!");
            showError(true);
        }
    };
    ...
    private BaseMediaPlayerListener mBasePlayerListener = new BaseMediaPlayerListener() {
        ...
        public void onError(int what, boolean canReload, String message) {
            if (mAutoReloadWhenError && canReload) {
                ...
                LogUtils.e(TAG, "Error! But Will Auto-Reload, playPosition = %d!!!", playPosition);
                mPlayerListener.onReloadFromPosition(playPosition);

                ThreadManager.getInstance().postOnUIHandlerDelayed(
                        mAutoReloadWaitingRunnable, 20 * 1000);
            } else {
                LogUtils.e(TAG, "Error! But Not Auto-Reload, Will Show Error!");
                showError(true);
            }
        }
    ...
    public void destroy() {
        ...
        handler.removeCallbacks(mAutoReloadWaitingRunnable);
    ...
    private void playMediaInternal() {
        ...
        ThreadManager.getInstance().getUIHandler().removeCallbacks(mAutoReloadWaitingRunnable);
