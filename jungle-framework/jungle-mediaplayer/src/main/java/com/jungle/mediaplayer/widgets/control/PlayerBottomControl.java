...
public class PlayerBottomControl extends FrameLayout {
    ...
    public void create(int resId) {
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            private void updateSeek(int progress, boolean doSeek) {
                ...
                mCurrentProgressView.setText(MiscUtils.formatTime(seekToPosition));
    ...
    private void clearUpdateProgress() {
        ThreadManager.getInstance().getUIHandler().removeCallbacks(mUpdateProgressRunnable);
    }
    ...
    public void setMediaPlayer(MediaPlayerFrame player) {
        ...
        mMediaPlayer.addPlayerListener(new BaseMediaPlayerListener() {
            ...
            public void onStartPlay() {
                ...
                ThreadManager.getInstance().postOnUIHandler(mUpdateProgressRunnable);
            }
    ...
    private void updateProgress() {
        ThreadManager.getInstance().postOnUIHandlerDelayed(mUpdateProgressRunnable, 1000);
    ...
    private void updateProgressInternal(int position, int duration) {
        ...
        mCurrentProgressView.setText(MiscUtils.formatTime(position));
        mTotalDurationView.setText(MiscUtils.formatTime(duration));
    }
