...
public class VertFlowLayout extends ViewGroup {
    ...
    private Stack<View> mRecycleViewList = new Stack<View>();
    private Map<Integer, ChildLayoutInfo> mInvisibleChildLayoutList =
            new HashMap<Integer, ChildLayoutInfo>();
    private Map<Integer, ChildLayoutInfo> mVisibleChildLayoutList =
            new HashMap<Integer, ChildLayoutInfo>();
